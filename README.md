...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/floral-butterfly-d76d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/floral-butterfly-d76d
```

A live public deployment of this template is available at [https://floral-butterfly-d76d.templates.workers.dev](https://floral-butterfly-d76d.templates.workers.dev)
